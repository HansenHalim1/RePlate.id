...
const HotDealsRibbon: React.FC<HotDealsRibbonProps> = ({ text = "Hot Deals!!" }) => {
  return (
    <div className="pointer-events-none absolute left-2 top-2 sm:left-10 sm:top-6 -rotate-6 sm:-rotate-12 z-20">
      <div className="relative inline-block">
        <div className="absolute inset-0 bg-[#7D8D2A] skew-x-[-15deg] rounded-md shadow-xl" />
        <span className="relative inline-block px-6 sm:px-8 py-2.5 sm:py-3 text-lg sm:text-xl font-semibold text-white tracking-wide">
          {text}
        </span>
      </div>
    </div>
